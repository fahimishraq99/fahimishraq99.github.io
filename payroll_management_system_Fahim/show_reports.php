<html lang="en">
  ...
  <body> 
	...
	<section id="header">
		<div class="row">  
            ...
            <div class="col-md-8" style="text-align: center"> 
				<a href="approved_reports.php" style="color:#33FF33;"> Approved Reports </a> 
			</div>			
	...
	<section id = "section1">
		<div class="title" style="color:#17202A;"> Employee's Leave Report </div>
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;background:#ffffff;">
			<div class="row" style="padding:5px;"> 
			<div class="col-md-2" style="color:#17202A;"> Employee ID </div> 
			<div class="col-md-2" style="color:#17202A;"> Approval Report </div> 
