<html lang="en">
  ...
  <body> 
	...
	<section id = "section1">
		<div class="title" style="color:#17202A;"> Number of Members in each Department </div>
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;background:#ffffff;">
			<div class="row" style="padding:5px;"> 
			<div class="col-md-3" style="color:#17202A;">  Assigned </div> 
			<div class="col-md-3" style="color:#17202A;">  Number </div>
            <!--			
			...
			$sql = "select assigned, count(*) from employee group by assigned";
