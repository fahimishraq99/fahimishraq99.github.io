<html lang="en">
  ...
  <body> 
	...
	<section id = "section1">
		<div class="title" style="color:#17202A;"> Departments List </div>
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;background:#ffffff;">
			<div class="row" style="padding:5px;"> 
			<div class="col-md-3" style="color:#17202A;">  Department ID </div> 
			<div class="col-md-3" style="color:#17202A;">  Name </div> 
			<div class="col-md-6" style="color:#17202A;">  Description </div> 
			</div>
